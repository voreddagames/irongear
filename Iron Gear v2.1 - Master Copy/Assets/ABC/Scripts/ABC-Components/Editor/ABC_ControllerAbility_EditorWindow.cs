...
public class ABC_ControllerAbility_EditorWindow : EditorWindow {
    ...
    public void GetAbilitySettings() {
        ...
        if (AbilityCount > 0 && this.currentAbility > this.Abilities.Count() - 1) {
                    ...
                    case 0:
                        ...
                        switch ((int)ToolbarAbilityManagerGeneralSettingsSelection) {
                            case 0:
                                ...
                                EditorGUILayout.EndHorizontal();
                                InspectorHelpBox("Determines the base initiating speed of the ability. Can also set for the ability to ignore initiating speed modifications due to global adjustments (from effects etc)", false);
                            ...
                            case 1:
                                ...
                                if (useInitiatingAesthetics.boolValue == true) {
                                    ...
                                    if (initiatingAestheticDetachFromParentAfterDelay.boolValue == true) {
                                        EditorGUILayout.PropertyField(initiatingAestheticDetachDelay, new GUIContent("Detach Delay"), GUILayout.MaxWidth(230));
                                    }
                                    EditorGUILayout.EndHorizontal();
