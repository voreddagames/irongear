...
public class ABC_GlobalPortal_EditorWindow : EditorWindow {
    ...
    public async void AddComponentPresets() {
        ...
        if (globalPortal.characterType != ABC_GlobalPortal.CharacterType.Player) {
            ...
            NavMeshAgent navMesh = CharacterObject.GetComponent<NavMeshAgent>();
            ...
            //and add nav obstacle 
            NavMeshObstacle navOb = CharacterObject.GetComponent<NavMeshObstacle>();
        ...
        //Capsule Collider
        CapsuleCollider capCol = CharacterObject.GetComponent<CapsuleCollider>();
    ...
    public void SetupCharacterTargetting() {
        ...
        if (globalPortal.characterType != ABC_GlobalPortal.CharacterType.Player || GetTarget.FindProperty("setupGameTypeTargetting").boolValue == false) {
            ...
            case ABC_GlobalPortal.GameType.Action:
                ...
                GetTargetABCManager.FindProperty("targetSelectType").enumValueIndex = 0;
                ...
                GetTargetABCManager.FindProperty("softTargetConfirmKey").enumValueIndex = 141;
            ...
            case ABC_GlobalPortal.GameType.TPS:
                ...
                GetTargetABCManager.FindProperty("softTargetConfirmKey").enumValueIndex = 0;
    ...
    public async void AddGameCamera() {
        ...
        if (globalPortal.characterType != ABC_GlobalPortal.CharacterType.Player || GetTarget.FindProperty("addCamera").boolValue == false) {
            return; 
        }
    ...
    public void AddMovement() {
        ...
        if (globalPortal.characterType != ABC_GlobalPortal.CharacterType.Player && CharacterObject.GetComponent<ABC_MovementController>() != null)
        ...
        if (globalPortal.characterType != ABC_GlobalPortal.CharacterType.Player || GetTarget.FindProperty("addMovement").boolValue == false) {
            return; 
        }
