...
public class ABC_CameraBase : MonoBehaviour {
    ...
    private void RotateCamera() {
        ...
        if (this.enableYRotation == true) {
            ...
            float yAxis = ((this.IsInputAvailable("RightStickVertical") ? ABC_InputManager.GetAxis("RightStickVertical") : 0) + ABC_InputManager.GetAxis("Mouse Y") * this.inputSensitivity);
        ...
        this.currentXRot += ((this.IsInputAvailable("RightStickHorizontal") ? ABC_InputManager.GetAxis("RightStickVertical") : 0) + ABC_InputManager.GetAxis("Mouse X")) * this.inputSensitivity;
