...
#region Entity Components
    ...
    public virtual void AddEffectsToEntity(string AbilityName, List<Effect> Effects, ABC_IEntity CastingOriginator, AbilityType AbilityType, bool IsEffectLink, GameObject Projectile = null, GameObject ObjectHit = null, Vector3 EffectHitPoint = default(Vector3),  bool ActivateAnimationFromHit = true, float ActivateAnimationFromHitDelay = 0f, AnimationClip ActivateAnimationFromHitClip = null, string SpecificAnimationToActivate = "", bool OverrideWeaponBlocking = false, bool ReduceWeaponBlockDurability = true, bool OverrideWeaponParrying = false, float PushAmount = 0f, float LiftAmount = 0f, float PushDelay = 0f) {
    ...
    public virtual void Push(float Distance,  Vector3 HitPoint, float Duration, float LiftDistance = 0, float Delay = 0f) {
        ...
        //If hitpoint not provided use position infront of entity
