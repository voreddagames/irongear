                ...
                case 0:
                    ...
                    switch ((int)generalSettingsToolbarSelection) {
                        case 0:
                            ...
                            EditorGUILayout.PropertyField(GetTarget.FindProperty("pickUpMode"), GUILayout.MaxWidth(260));
                            ...
                            if ((string)(GetTarget.FindProperty("pickUpMode")).enumNames[GetTarget.FindProperty("pickUpMode").enumValueIndex] == "Enable") {
                                ...
                                if (GetTarget.FindProperty("enableWeaponUsingName").boolValue == true) {
                                    ...
                                    EditorGUILayout.PropertyField(GetTarget.FindProperty("weaponLinkID"), new GUIContent("Weapon ID"), GUILayout.MaxWidth(250));
                                }
                                ...
                                if (GUILayout.Button("Update" , GUILayout.Width(180))) {
                                    ...
                                    ABC_WeaponPickUp.EnableOrImport currentPickUpMode = weaponPickUpManager.pickUpMode;
                                    weaponPickUpManager.ImportGlobalWeapon(this.GlobalWeapons.Keys.ToArray()[this.globalWeaponsListChoice]);
                                    weaponPickUpManager.pickUpMode = currentPickUpMode;
                            ...
                            if ((string)(GetTarget.FindProperty("pickUpMode")).enumNames[GetTarget.FindProperty("pickUpMode").enumValueIndex] == "Import") {
                                EditorGUIUtility.labelWidth = 180;
